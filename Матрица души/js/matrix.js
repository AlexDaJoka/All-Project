class Matrix{
    ...
    set_decryption(response, data1){
        ...
        jQuery('.decryption_second .decryption__heading').after(response['html2'])
        let healthcard_matrix = jQuery('.calculation .calculation__health-card.health-card').clone();//.appendTo('.calculation_second .health-card__img.health-card__img-flex');
        healthcard_matrix.find('.health-card__destination.destination').remove();
        healthcard_matrix.find('.healthcard-remove').remove();
        healthcard_matrix.insertBefore('.decryption_second .decryption-content .chackra-img');
    ...
    show_matrix(){
        ...
        // jQuery('.calculation .health-card__img.health-card__img-flex svg').clone().appendTo('.calculation_second .health-card__img.health-card__img-flex');
        jQuery('.calculation_second .calculation__hidden').addClass('show');
        jQuery('.decryption_second').addClass('show');
